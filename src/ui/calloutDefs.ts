...
export const CALLOUTS: CalloutDef[] = [
  { id: 'display', num: 1, part: 'Display', note: 'Tap an icon to open a page', anchor: [-0.37, 0.36, 0.5], badge: [-56, -36] },
  { id: 'a', num: 2, part: 'Left button', note: 'Next · ← →', anchor: [-0.36, -0.86, 0.56], badge: [-50, 34] },
  { id: 'b', num: 3, part: 'Middle button', note: 'Open · Enter', anchor: [0, -0.93, 0.56], badge: [0, 54] },
  { id: 'c', num: 4, part: 'Right button', note: 'Back · Esc', anchor: [0.36, -0.86, 0.56], badge: [50, 34] },
